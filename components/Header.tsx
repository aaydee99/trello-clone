...
const Header: FC<HeaderProps> = ({ }) => {
    ...
    return (
        <header>
            <div className='flex flex-col md:flex-row items-center p-5 bg-gray-500/10  rounded-b-2xl mb-7'>
                ...
                <div className='flex items-center space-x-5 flex-1 justify-end w-full'>
                    ...
                    <form className='flex items-center space-x-5 bg-white rounded-md p-2 shadow-md flex-1 md:flex-initial'>
                        ...
                        <input type='text' title='Search Input' placeholder='Search' className='flex-1 outline-none p-2' value={searchString} onChange={(e)=>setSearchString(e.target.value)} />
                        <button hidden type='submit' >Search</button>
                    </form>

                    {/* Avatar */}
                    <Avatar name='User' round color='#0055D1' size='50'/>
